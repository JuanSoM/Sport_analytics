...
\begin{document}
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{Esquema conceptual del proceso de detección tipo YOLO. La secuencia ilustra la imagen de entrada, su discretización espacial en rejilla y la identificación de regiones relevantes para la predicción de objetos. Fuente: adaptación propia a partir de \cite{csdn_yolo_intro}.}
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{Detalle conceptual de la estimación de cajas delimitadoras en detectores tipo YOLO. Estas figuras ayudan a interpretar cómo se ajusta la localización del objeto y cómo el solapamiento entre regiones candidatas influye en la selección final. Fuente: adaptación propia a partir de \cite{csdn_yolo_intro}.}
