...
\begin{document}
	...
	\begin{chaptertemplatebox}
		...
		\textbf{Configuración}\\
		Modelo OSNet x1.0 \textit{fine-tuned} para deporte, secuencia SoccerNet SNMOT-060, 750 frames y 26 IDs del GT relevantes para el análisis. Se estudió el embedding tanto en aislamiento como en interacción con configuraciones de tracking.\\[0.5em]
