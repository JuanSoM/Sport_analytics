...
\begin{document}
	...
	\begin{chaptertemplatebox}
		...
		El trabajo confirma que ByteTrack constituye una base sólida para el seguimiento de futbolistas, que la continuidad de identidad es el cuello de botella principal del problema, que el ReID aporta valor pero debe integrarse con cautela, y que la combinación de validación geométrica y linking offline permite obtener un sistema final más útil que la simple optimización de una métrica aislada.\\[0.5em]
	...
	La tercera aportación es el diseño y evaluación de un enfoque combinado de mejora, basado en integración online de apariencia, linking offline y control de coherencia espacial. La incorporación de una heurística como \textit{Zone Fix} no pretende ser una teoría general del movimiento, pero sí representa una contribución práctica importante: introduce una salvaguarda explícita frente a uno de los modos de fallo más dañinos detectados durante el proyecto.
	...
	También resulta prometedor profundizar en la interacción entre linking offline y validación geométrica. En este trabajo ambas capas han mostrado ser complementarias, pero todavía existe margen para estudiar políticas más finas de cuándo cortar, cuándo preservar y cuándo recomponer trayectorias.
